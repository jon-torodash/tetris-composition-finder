...
<p>
1) Decompose the board columnwise. We count how many ways the 10 column Tetris board can be broken up such with at least one single column component. (Because a single straight vertical Tetris piece  is needed to fill ("complete") a Tetris.) For example, {1,4,5} and {2,1,3,2,1,1} would work, but {4,6} and {3,3,2,2} would not, because they do not contain at least one "1" as part of a column-group decomposition of the board.
</p><p>
